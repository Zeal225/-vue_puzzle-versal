<template>
    <section class="section  section-inscription">
        <div class="container inscription-container">
            <div class="content inscription-membre inscription-content">
                <div class="user-infos">
                    <div class="user-image">
                        <div class="modification-membre user-image-content">
                            <img v-bind:src="'/dist/images/icones/'+$store.getters.getUser.image" alt="">
                        </div>
                    </div>
                    <div class="user-other-infos">
                        <div class="name">
                            <div class="input-bloc input-nom">
                                <input type="text" placeholder="votre nom" class="nom" v-model="$store.getters.getUser.nom">
                            </div>
                            <div class="input-bloc input-prenom">
                                <input type="text" placeholder="votre prenom" class="prenom" v-model="$store.getters.getUser.prenom">
                            </div>
                        </div>
                        <div class="birthday">
                            <label class="legend-born" for="born">né le: </label>
                            <input id="born" type="text" class="date" v-model="$store.getters.getUser.date_naissance">
                        </div>
                        <div class="email-social">
                            <div class="email">
                                <input type="email" class="email" placeholder="votre email" v-model="$store.getters.getUser.email">
                            </div>
                            <div class="social-bloc">
                                <span class="social-text">ou connecter vous avec</span>
                                <div class="social-bloc-icon">
                                    <a href="">
