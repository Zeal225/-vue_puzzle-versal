                    ...
                    <div class="user-other-infos">
                        <div class="name">
                            ...
                            <div class="input-bloc input-prenom">
                                <input type="text" placeholder="votre prenom" class="prenom">
                            </div>
                        </div>
                        <div class="birthday">
                            <label class="legend-born" for="born">né le: </label>
                            <input id="born" type="date" class="date">
                        </div>
...
<polyline class="st0" points="44.3,100 83.8,60.5 43.2,20 "></polyline>
                ...
                <div class="valider">
                    <h4 class="section-link">
                        <router-link :to="{ name: 'membre', params:{id: $store.getters.getUser.id, name: $store.getters.getUser.nom } }">
                            valider
